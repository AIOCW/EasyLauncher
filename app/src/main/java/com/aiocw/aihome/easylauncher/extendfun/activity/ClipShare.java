...
public class ClipShare extends WaysActivity implements OnSendMessageListener {
...
//        params.width = (int) (display.getWidth() * 0.8);
        ...
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(ClipShare.this);
        otherHostRecyclerView.setLayoutManager(linearLayoutManager);
        otherHostRecyclerView.setAdapter(new OtherHostRecyclerViewAdapter(ClipShare.this, otherHostList, this));
        ...
        String clipData = intent.getStringExtra("clip_data");
        textMessage = clipData;
