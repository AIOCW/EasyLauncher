...
public class OpenWaysActivity extends WaysActivity implements OnSendMessageListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        // 实现悬浮透明试的activity 需要继承自Activity
...
//        params.width = (int) (display.getWidth() * 0.8);
        ...
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(OpenWaysActivity.this);
        otherHostRecyclerView.setLayoutManager(linearLayoutManager);
        otherHostRecyclerView.setAdapter(new OtherHostRecyclerViewAdapter(OpenWaysActivity.this, otherHostList, this));
        ...
        if (Intent.ACTION_VIEW.equals(action)) {
            ...
            String  url1 = intent.getDataString();
                ...
                switch (XFileTools.getFileClass(filePath)) {
                    case 0:
                        Log.i(TAG + "FileClass", XFileTools.fileClassStrings[0]);
                        break;
                    case 1:
                        Log.i(TAG + "FileClass", XFileTools.fileClassStrings[1]);
                        break;
                    case 2:
                        Log.i(TAG + "FileClass", XFileTools.fileClassStrings[2]);
                        break;
                    case 3:
                        Log.i(TAG + "FileClass", XFileTools.fileClassStrings[3]);
                        break;
                    case 4:
                        Log.i(TAG + "FileClass", XFileTools.fileClassStrings[4]);
                        break;
                    case 5:
                        Log.i(TAG + "FileClass", XFileTools.fileClassStrings[5]);
                        break;
                    case 6:
                        Log.i(TAG + "FileClass", XFileTools.fileClassStrings[6]);
                        break;
                    case -1:
                        break;
                }
