...
//        Log.i("GETFileInfo", file.getName());
//        Log.i("GETFileInfo", String.valueOf(file.getFreeSpace()));
//        Log.i("GETFileInfo", String.valueOf(file.getTotalSpace()));
    ...
    public static JSONObject sendFileJsonMessage(String filePath, String aimDevice) {
        String md5 = SecurityEncryption.getFileMD5(filePath);
        FileInformation fileInformation = getFileInfo(filePath);
        //创建JSONObject
        JSONObject  jsonObject = new JSONObject();
        //键值对赋值
        try {
            jsonObject.put("filename", fileInformation.getFilename());
            jsonObject.put("filesize", fileInformation.getFilesize());
            jsonObject.put("filepath", "file/");
            jsonObject.put("aim_device", aimDevice);
        ...
        //输出日志
        Log.e("FileTools = ObjectToJson", json);
        return jsonObject;
    }
