...
public class WebDavActivity extends AppCompatActivity {
    private String TAG = "WebDavActivity";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        btnApply.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // 写入sharedpreference
                SharedPreferences sharedPreferences = WebDavActivity.this.getSharedPreferences(CommonStaticData.APP_SETTING_FILE_NAME, 0);
    ...
    Handler mClientHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case 71001:
                    Log.e(TAG, "确认");
//                    Toast.makeText(WebDavActivity.this, R.string.net_setting_change_success, Toast.LENGTH_LONG);
                    WebDavActivity.this.finish();
                    break;
                default:
//                    Toast.makeText(WebDavActivity.this, "error", Toast.LENGTH_SHORT);
